...
Para o acompanhamento dessa aula foi utilizado o [container](db/Docker/) criado na [aula 3](#32-instalação), mais especificamente o processo de instalação com docker.  
...
Onde a diferença entre essas duas utilizações é quando se é criado uma collection de forma explicita, é possível passar alguns validadores para essa criação, como por exemplo: tamanho máximo do documento, tamanho máximo da collection, tamanho máximo de documentos permitidos etc..
...
```
Neste comando acima, que é utilizado quando vamos inserir __um único__ documento na collection, e tem como retorno qual o `ObjectID` ou seja qual o ID do objeto que acabou de ser criado. 
