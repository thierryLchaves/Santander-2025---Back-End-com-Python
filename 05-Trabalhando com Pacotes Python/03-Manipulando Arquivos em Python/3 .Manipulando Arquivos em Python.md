...
- [Desafio](#9-explicação-desafio)
  - [Introdução ao desafio](#91-introdução)
  - [Objetivos](#92-objetivos)
  - [Requisitos](#93-requisitos)
...
### 9.2. Objetivos
Modificar o atual decorador de log, que imprime informações no console, para que ele salva essas informações mais fácil e uma análise mais detalhada das operações dos usuários.   
### 9.3 Requisitos 
O decorador deve registrar o seguinte para cada chamada de função:  
- Data e hora atuais. 
- Nome da função 
- Argumentos da função 
- O arquivo de log de ser chamado log.txt
...
o resultado pode ser encontrado [aqui](https://github.com/thierryLchaves/Desafios-Python-DIO/tree/Manipulando_Arquivos/Manipulando%20Arquivos)
